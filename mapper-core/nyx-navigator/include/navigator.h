 ...
 */
void navigator_free_string(char *ptr);
 ...
 * ```
 */
char *navigator_map_project(const char *path);
 ...
 * ```
 */
char *navigator_health(const char *path);
 ...
 * ```
 */
char *navigator_check_layers(const char *path, const char *layers_path);
 ...
 * ```
 */
char *navigator_simulate_change(const char *path,
 ...
 * ```
 */
char *navigator_skeleton_map(const char *path, const char *detail);
 ...
 * ```
 */
char *navigator_module_context(const char *path, const char *module_id, uint32_t depth);
 ...
 */
char *navigator_git_churn(const char *path, uint32_t limit);
 ...
 */
char *navigator_git_cochange(const char *path, uint32_t limit, uint32_t min_count);
 ...
 * ```
 */
char *navigator_semidiff(const char *path, const char *commit1, const char *commit2);
 ...
 * Returns an empty array when the directory is not a git repo.
 */
char *navigator_hidden_coupling(const char *path, uint32_t limit, uint32_t min_count);
 ...
 * ```
 */
char *navigator_ranked_skeleton(const char *path,
 ...
 * ```
 */
char *navigator_unreferenced_symbols(const char *path);
 ...
 * ```
 */
char *navigator_search_content(const char *path, const char *pattern, const char *opts_json);
 ...
 * ```
 */
char *navigator_find_files(const char *path,
                           const char *pattern,
                           uint32_t limit,
 ...
 * ```
 */
char *navigator_poll_changes(const char *path, uint64_t since_ms);
 ...
 * ```
 */
char *navigator_replace_content(const char *path,
                                const char *pattern,
 ...
 * ```
 */
char *navigator_extract_content(const char *path, const char *pattern, const char *opts_json);
 ...
 * ```
 */
char *navigator_context_health(const char *content, const char *opts_json);
 ...
 * ```
 */
char *navigator_bm25_search(const char *path, const char *query, const char *opts_json);
 ...
 * ```
 */
char *navigator_query_context(const char *path, const char *query, const char *opts_json);
 ...
 * ```
 */
char *navigator_shotgun_surgery(const char *path, uint32_t limit, uint32_t min_partners);
 ...
 * ```
 */
char *navigator_doc_index(const char *path);
 ...
 * ```
 */
char *navigator_doc_context(const char *path, const char *doc_path, uint32_t budget);
 ...
 * ```
 */
char *navigator_query_docs(const char *path, const char *query, const char *opts_json);
 ...
 * ```
 */
char *navigator_render_architecture(const char *path,
                                    const char *format,
                                    const char *focus,
                                    uint32_t depth,
                                    uint32_t max_nodes);
