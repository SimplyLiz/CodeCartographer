//! File-local call-graph extraction for Rust, Python, and Go.
#![allow(dead_code)]
//!
...
//!
//! Gated on `lang-rust` / `lang-python` / `lang-go` Cargo features, matching
//! the rest of the tree-sitter surface in `extractor.rs`.

use std::path::Path;

use crate::api::{GraphEdge, GraphMetadata, GraphNode, ProjectGraphResponse};

#[cfg(any(feature = "lang-rust", feature = "lang-python", feature = "lang-go"))]
