# Project Nyx.Navigator Integration Guide

## Overview
Project Nyx.Navigator provides semantic workspace mapping to enhance the capabilities of AI agents like ShellAI by offering a highly compressed yet semantically rich understanding of codebases. This dramatically reduces token usage and expands the context window available to LLMs.

## Integration with ShellAI
ShellAI leverages the `get_module_context` API endpoint provided by Project Nyx.Navigator for targeted code queries. This API allows ShellAI to:
